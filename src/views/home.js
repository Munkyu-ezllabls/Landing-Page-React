    ...
    <div className="home-container">
      ...
      <div id="inspiration" className="home-features">
        <div className="home-heading-container">
          <h2 className="home-text Section-Heading">
      ...
      <div className="home-team">
        <div className="home-heading-container2">
          <h1 className="home-text15 Section-Heading">Meet the Team</h1>
      ...
      <div id="ourstory" className="home-our-story">
        <div className="home-heading-container3">
          <h1 className="home-text17 Section-Heading">Our story</h1>
          ...
          <div className="home-right-section">
            <div className="home-card">
              ...
              <div className="home-content-container2">
                <span className="home-text23 SmallCard-Heading">
                  This text is the name of the article. Lorem ipsum dolor sit
                  metsed ...
                </span>
                <span className="Anchor">Read more</span>
      ...
      <div className="home-get-in-touch">
        <h2 className="home-text35 Section-Heading">Get in touch</h2>
